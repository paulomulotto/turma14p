...
public class Formacao implements PadraoFormacao{
	...
	/*
	 * Polimorfismo: um mesmo método pode ser utilizado para várias situações.
	 * Overload (sobrecarga): quando os métodos estão na mesma classe (devem possuir assinaturas diferentes)
	 * Override (sobrescrita): quando os métodos estão em classes distintas (classe pai e filha). 
	 */
